                            ...
                            <div class="row">
                                ...
                                <div class="form-group mb-3 col-md-6 datetimepickers">
                                    ...
                                    <div class="input-group date" id="datetimepicker-01" data-target-input="nearest">
                                        <input type="text" class="form-control datetimepicker-input" value="08/11/1999"
                                ...
                                <div class="form-group mb-0 col-md-12">
                                    ...
                                    <textarea class="form-control" rows="5"
                                        placeholder="Give yourself the power of responsibility. Remind yourself the only thing stopping you is yourself."></textarea>
                                </div>
                            </div>
                        </form>
                    </div>
